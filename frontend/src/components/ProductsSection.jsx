...
const DEMO_FOOD = [
  ...
  {
    _id: 'f-sp-1',
    name: 'Pani Puri Shawarma',
    price: 120,
    category: { name: 'Shawarma' },
    imageUrl: '/food/panipurishawarma.webp',
    description: 'Unique fusion of crunchy Pani Puri spices & tangy mint chutney stuffed inside juicy chicken shawarma.',
  },
  {
    _id: 'f-16',
    name: 'Shawarma Roll',
  ...
  {
    _id: 'f-alf-1',
    name: 'Honey Chilli Alfham',
    category: { name: 'Alfham & Shawai' },
    imageUrl: '/food/honeychillialfham.webp',
    description: 'Charcoal grilled Alfham chicken coated with spicy red chilli and sweet honey glaze.',
    options: [
      { size: 'Quarter (Q)', price: 130 },
      { size: 'Half (H)', price: 250 },
      { size: 'Full (F)', price: 570 },
    ],
  },
  {
    _id: 'f-alf-2',
    ...
    category: { name: 'Alfham & Shawai' },
    imageUrl: '/food/periperialfham.webp',
    description: 'Fiery African Peri Peri seasoned chicken grilled over live charcoal.',
    options: [
      { size: 'Quarter (Q)', price: 130 },
      { size: 'Half (H)', price: 250 },
      { size: 'Full (F)', price: 500 },
    ],
  },
  {
    _id: 'f-alf-3',
    name: 'Normal Alfham',
    category: { name: 'Alfham & Shawai' },
    imageUrl: '/food/normalaflham.webp',
    description: 'Classic Arabian charcoal grilled Alfham chicken served with garlic paste & kubbus.',
    options: [
      { size: 'Quarter (Q)', price: 125 },
      { size: 'Half (H)', price: 240 },
      { size: 'Full (F)', price: 480 },
    ],
  },
  {
    _id: 'f-alf-4',
    name: 'Normal Shawai',
    category: { name: 'Alfham & Shawai' },
    imageUrl: '/food/normalshawai.webp',
    description: 'Tender rotisserie roasted chicken marinated in aromatic Middle Eastern spices.',
    options: [
      { size: 'Quarter (Q)', price: 125 },
      { size: 'Half (H)', price: 240 },
      { size: 'Full (F)', price: 480 },
  ...
  // ── LIME & MOJITOS ──
  {
    ...
    name: 'Mint Lime',
    price: 30,
    category: { name: 'Lime & Mojitos' },
    imageUrl: '/drinks/mintlime.webp',
    description: 'Refreshing chilled fresh lime juice crushed with garden mint leaves.',
  },
  {
    _id: 'f-drk-2',
    ...
    price: 50,
    category: { name: 'Lime & Mojitos' },
    imageUrl: '/drinks/greenapple.webp',
    description: 'Zesty lime juice blended with sweet green apple flavor.',
  },
  {
    _id: 'f-22',
    name: 'Fresh Lime',
    price: 20,
    category: { name: 'Lime & Mojitos' },
    imageUrl: '/drinks/freshlime.webp',
  ...
  },
  {
    ...
    price: 30,
    category: { name: 'Lime & Mojitos' },
    imageUrl: '/drinks/grapelime.webp',
  ...
  // ── FRESH JUICES ──
  {
    ...
    name: 'Apple Juice',
    price: 80,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/applejuice.webp',
    description: 'Freshly extracted sweet red apple juice served chilled.',
  },
  {
    _id: 'f-juc-2',
    name: 'Anar Juice',
    price: 80,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/anarjuice.webp',
    description: 'Rich natural juice pressed from fresh pomegranate seeds.',
  },
  {
    _id: 'f-juc-3',
    name: 'Avocado Shake',
    price: 80,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/avacadojuice.webp',
    description: 'Creamy, rich and thick fresh butterfruit (avocado) shake.',
  },
  {
    _id: 'f-juc-4',
    name: 'Mosambi Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/mosambijuice.webp',
    description: 'Freshly squeezed sweet lime juice packed with Vitamin C.',
  },
  {
    _id: 'f-juc-5',
    name: 'Orange Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/orange.webp',
    description: '100% natural freshly squeezed sweet orange juice.',
  },
  {
    _id: 'f-juc-6',
    ...
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/pineapplejuice.webp',
    description: 'Sweet and tangy juice crushed from fresh pineapples.',
  },
  {
    _id: 'f-juc-7',
    name: 'Chikku Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/chikkujuice.webp',
    description: 'Deliciously thick and sweet sapota (chikku) shake.',
  },
  {
    _id: 'f-juc-8',
    name: 'Mango Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/mangojuice.webp',
    description: 'Luscious thick juice made from sweet ripe mangoes.',
  },
  {
    _id: 'f-juc-9',
    name: 'Papaya Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/pappayajuice.webp',
    description: 'Smooth and nutritious fresh papaya blend.',
  },
  {
    _id: 'f-juc-10',
    name: 'Grape Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/grapejuice.webp',
    description: 'Refreshing chilled black grape juice.',
  },
  {
    _id: 'f-juc-11',
    name: 'Shamam Juice',
    price: 70,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/shamamjuice.webp',
    description: 'Cooling fresh muskmelon (shamam) juice.',
  },
  {
    _id: 'f-juc-12',
    ...
    price: 50,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/watermelonjuice.webp',
    description: 'Hydrating fresh red watermelon juice.',
  },
  {
    _id: 'f-juc-13',
    ...
    price: 80,
    category: { name: 'Fresh Juices' },
    imageUrl: '/drinks/tendercoconutjuice.webp',
    description: 'Pure fresh tender coconut pulp blended smoothie.',
  },
  ...
  // ── TEA & COFFEE ──
  {
    ...
    name: 'Black Tea',
    price: 10,
    category: { name: 'Tea & Coffee' },
    imageUrl: '/drinks/blacktea.webp',
    description: 'Hot aromatic brewed strong black tea.',
  },
  {
    _id: 'f-tea-2',
    name: 'Tea',
    price: 15,
    category: { name: 'Tea & Coffee' },
    imageUrl: '/drinks/tea.webp',
    description: 'Traditional hot cardamom milk tea.',
  },
  {
    _id: 'f-tea-3',
    name: 'Lemon Tea',
    price: 15,
    category: { name: 'Tea & Coffee' },
    imageUrl: '/drinks/lemontea.webp',
    description: 'Hot black tea infused with fresh citrus lemon juice.',
  },
